...
description: >-
  ...
  the model's weights. Use this skill whenever the user wants to make a repo agent-ready or
  ...
  planner/generator/evaluator (worker–checker) workflow. Trigger this even when the user doesn't say
  the word "harness" — phrases like "the agent keeps breaking my build", "Claude forgets context
